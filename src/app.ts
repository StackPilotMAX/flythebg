...
function contact():string{return shell(`<main class="page prose reveal"><p class="eyebrow">CONTACT</p><h1>Talk to the project.</h1><p>For privacy requests, security reports, feedback or project communication:</p><a class="contact-card" href="mailto:support@flythebg.com"><span>Email</span><strong>support@flythebg.com</strong></a><div class="contact-links"><a href="${FLYTHEBG_INSTAGRAM}" target="_blank" rel="noopener noreferrer"><i class="fa-brands fa-instagram" aria-hidden="true"></i> @flythebg</a><a href="${OWNER_INSTAGRAM}" target="_blank" rel="noopener noreferrer"><i class="fa-brands fa-instagram" aria-hidden="true"></i> @aadarshf1</a><a href="${GITHUB_REPO}" target="_blank" rel="noopener noreferrer"><i class="fa-brands fa-github" aria-hidden="true"></i> FlyThe BG GitHub repository</a><a href="${GITHUB_PROFILE}" target="_blank" rel="noopener noreferrer"><i class="fa-brands fa-github" aria-hidden="true"></i> StackPilotMAX GitHub</a></div></main>`,"Contact — FlyThe BG");}
