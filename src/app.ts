...
function toolPage(id:ToolId,num:string,title:string,description:string,accept:string,note:string,privacy:string):string{
 const consent=id==="remove-bg"?`<label class="consent"><input type="checkbox" data-consent="remove-bg"><span>I understand that my selected image will be sent to the protected background-removal processor.</span></label>`:"";
...
function home():string{return shell(`<main><section class="hero"><video class="hero-video" autoplay muted loop playsinline preload="metadata" poster="${POSTER}" aria-hidden="true"><source src="${VIDEO}" type="video/mp4"></video><div class="hero-noise"></div><div class="hero-shade"></div><div class="hero-copy reveal"><p class="eyebrow">THE INTERNET'S LITTLE MEDIA SIDEKICK</p><h1 class="calligraphy">Create.<br>Clean.<br>Fly.</h1><p class="hero-sub">Remove backgrounds. Compress images. Compress video. No 47-step tutorial arc.</p><div class="actions"><a class="button primary" href="/features">Get started →</a><a class="button ghost" href="#tools">See the chaos</a></div><div class="hero-micro"><span>⚡ browser-first</span><span>🫶 no account</span><span>🧠 AI when needed</span></div></div><div class="scroll-cue">scroll ↓</div></section>
<section id="tools" class="section reveal"><div class="center-heading"><p class="eyebrow">THE TOOLKIT</p><h2>Three buttons.<br>zero corporate fog.</h2><p>Pick a job, drop a file, get the result. Compression is local; background removal uses the protected AI route.</p></div><div class="tool-links"><a href="/remove-bg"><span>01</span><div><b>Remove Background</b><small>AI-powered · protected upload</small></div><strong>↗</strong></a><a href="/image-compressor"><span>02</span><div><b>Compress Image</b><small>local · JPEG output · no upload</small></div><strong>↗</strong></a><a href="/video-compressor"><span>03</span><div><b>Compress Video</b><small>local · WebM output · live progress</small></div><strong>↗</strong></a></div></section>
<section class="ticker"><div>less waiting ✦ less uploading ✦ more making ✦ less waiting ✦ less uploading ✦ more making ✦</div></section>${aiPulse()}<section class="section centered-section reveal"><p class="eyebrow">INTERNET SURVIVAL TIP</p><h2>if an AI says “trust me”<br>make it show the work.</h2><p>Use AI for speed, not blind trust. Verify important facts and never paste private keys into prompts.</p></section></main>`,"FlyThe BG — media tools without the meh");}
